<?php
//重新加载
function ydtu_rebuild_Main() {
	global $zbp;
	$zbp->RegBuildModule('comments','ydtu_side_comm');
	$zbp->RegBuildModule('tags','ydtu_hotTags');
		$zbp->RegBuildModule('catalog','ydtu_catalog');
}

function ydtu_hotTags(){
    global $zbp,$str;
    $str = '';
...
function ydtu_side_comm() {
	...
	foreach ($comments as $comment) {
		$randimg=rand(1,36);$randimg=$zbp->host."zb_users/theme/ydtu/include/avator/$randimg.jpg";
